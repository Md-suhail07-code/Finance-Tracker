...
const Login: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 sm:relative sm:min-h-screen w-screen sm:w-full flex items-center justify-center bg-slate-50 dark:bg-black px-0 sm:px-6 lg:px-8 font-sans antialiased selection:bg-emerald-500/30 selection:text-emerald-200 overflow-x-hidden transition-colors duration-200">
      ...
      <div className="absolute top-1/4 left-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-emerald-500/10 dark:bg-emerald-500/5 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-cyan-500/10 dark:bg-cyan-500/5 rounded-full blur-3xl pointer-events-none"></div>

      <div className="w-full h-full sm:h-auto sm:max-w-md bg-white/80 dark:bg-zinc-950/40 backdrop-blur-3xl border-0 sm:border sm:border-slate-200 dark:sm:border-white/5 sm:rounded-3xl p-6 xs:p-8 sm:p-10 flex flex-col justify-center shadow-lg dark:shadow-[0_8px_48px_0_rgba(0,255,155,0.1)] relative overflow-hidden group z-10">
        ...
        <div className="flex flex-col items-center mb-6 sm:mb-8 text-center">
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-slate-100 dark:bg-zinc-900 border border-slate-200 dark:border-white/5 flex items-center justify-center shadow-lg shadow-emerald-500/10 mb-3 sm:mb-4 transition-transform duration-300 hover:scale-105 overflow-hidden">
            <img
              src={Logo}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
          {/* Email Field */}
          <div>
            <label className="block text-[10px] sm:text-xs font-medium text-slate-500 dark:text-zinc-400 uppercase tracking-wider mb-1.5 sm:mb-2">
              Email
            </label>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5 sm:mb-2">
              <label className="block text-[10px] sm:text-xs font-medium text-slate-500 dark:text-zinc-400 uppercase tracking-wider">
                Password
              </label>
              <a
                href="#forgot"
                className="text-[10px] sm:text-[11px] font-medium text-teal-600 dark:text-teal-400 hover:text-emerald-600 dark:hover:text-emerald-300 transition duration-150"
              >
                Forgot password?
              </a>
            </div>
          ...
          <button
            type="submit"
            className="w-full mt-2 py-3.5 sm:py-4 px-4 bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-600 hover:from-emerald-600 hover:to-cyan-700 text-zinc-950 rounded-2xl font-bold text-sm tracking-wide active:scale-[0.99] transition-all duration-150 shadow-[0_8px_32px_0_rgba(5,255,155,0.2)] cursor-pointer"
          >
            {loading ? (
        ...
        <div className="mt-6 sm:mt-8 pt-5 sm:pt-6 border-t border-slate-200 dark:border-white/5 text-center">
          <p className="text-xs text-slate-500 dark:text-zinc-400">
            Not registered yet?{" "}
            <button
              onClick={() => navigate("/signup")}
              className="text-teal-600 dark:text-teal-400 hover:text-emerald-600 dark:hover:text-emerald-300 font-medium transition duration-150 cursor-pointer"
            >
              Create an account
            </button>
          </p>
