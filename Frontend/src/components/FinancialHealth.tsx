    ...
    <div className="bg-white/80 dark:bg-zinc-950/40 backdrop-blur-3xl border border-slate-200 dark:border-white/5 rounded-2xl p-4 sm:p-6 shadow-sm dark:shadow-[0_4px_24px_rgba(0,0,0,0.3)]">
      ...
      <div className="grid grid-cols-1 gap-6 items-center">
        ...
        <div className="md:col-span-7 grid grid-cols-2 gap-3 w-full">
          ...
          <div className="p-3 bg-slate-50/80 dark:bg-black/30 border border-slate-200 dark:border-white/5 rounded-xl flex items-center gap-3">
            ...
            <div className="min-w-0">
              <span className="text-[9px] uppercase font-bold tracking-wider text-slate-500 dark:text-zinc-500 block">Income Flow</span>
              <span className="text-xs font-bold font-mono text-slate-900 dark:text-zinc-200 truncate block mt-0.5">
          ...
          <div className="p-3 bg-slate-50/80 dark:bg-black/30 border border-slate-200 dark:border-white/5 rounded-xl flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-rose-500/10 border border-rose-500/20 flex items-center justify-center text-rose-500 dark:text-rose-400 shrink-0">
              <ArrowDownLeft className="w-4 h-4" />
            </div>
            <div className="min-w-0">
              <span className="text-[9px] uppercase font-bold tracking-wider text-slate-500 dark:text-zinc-500 block">Outflow Total</span>
              <span className="text-xs font-bold font-mono text-slate-900 dark:text-zinc-200 truncate block mt-0.5">
          ...
          <div className="p-3 bg-slate-50/80 dark:bg-black/30 border border-slate-200 dark:border-white/5 rounded-xl flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-600 dark:text-cyan-400 shrink-0">
              <PiggyBank className="w-4 h-4" />
            </div>
            <div className="min-w-0">
              <span className="text-[9px] uppercase font-bold tracking-wider text-slate-500 dark:text-zinc-500 block">Savings Velocity</span>
          ...
          <div className="p-3 bg-slate-50/80 dark:bg-black/30 border border-slate-200 dark:border-white/5 rounded-xl flex items-center gap-3">
            ...
            <div className="min-w-0">
              <span className="text-[9px] uppercase font-bold tracking-wider text-slate-500 dark:text-zinc-500 block">Budget Burn</span>
              <span className="text-xs font-bold font-mono text-slate-900 dark:text-zinc-200 block mt-0.5">
